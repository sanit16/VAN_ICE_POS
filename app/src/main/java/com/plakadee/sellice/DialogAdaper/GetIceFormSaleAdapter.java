package com.plakadee.sellice.DialogAdaper;
...
import com.plakadee.sellice.Spiner.SelectPriceCallBack;

import java.util.List;

public class GetIceFormSaleAdapter extends RecyclerView.Adapter<GetIceFormSaleAdapter.MyViewHolder> {
    private Context mContext;
    public List<OrderDeatail> mData;

    public GetIceFormSaleAdapter(Context mContext, List<OrderDeatail> mData) {
    ...
    @Override
    public GetIceFormSaleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view;
        LayoutInflater mInflater = LayoutInflater.from(mContext);
        view = mInflater.inflate(R.layout.get_product_card, parent, false);
        return new GetIceFormSaleAdapter.MyViewHolder(view);
    }


    @Override
    public void onBindViewHolder(final GetIceFormSaleAdapter.MyViewHolder holder, final int position) {
