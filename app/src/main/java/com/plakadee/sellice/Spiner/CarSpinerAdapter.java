...
public class CarSpinerAdapter extends RecyclerView.Adapter<CarSpinerAdapter.MyViewHolder> {
    private Context mContext;
    List<Car> mData;
    SelectCallback selectCallback;

    public CarSpinerAdapter(Context mContext, List<Car> mData ,SelectCallback selectCallback) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.select_car_card, parent, false);
