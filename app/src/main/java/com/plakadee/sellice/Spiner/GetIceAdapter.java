...
public class GetIceAdapter extends RecyclerView.Adapter<GetIceAdapter.MyViewHolder> {
    private Context mContext;
    public List<OrderDeatail> mData;
    GetIceInterface getIceInterface;

    public GetIceAdapter(Context mContext, List<OrderDeatail> mData, GetIceInterface getIceInterface) {
