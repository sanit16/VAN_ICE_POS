...
public class GetCarAdapter extends RecyclerView.Adapter<GetCarAdapter.MyViewHolder> {
   ...
   public String runno;
    ...
    public GetCarAdapter(Context mContext, List<Car> mData , TransferInterface transferInterface) {
