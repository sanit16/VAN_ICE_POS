...
public class ReciveAdapter extends RecyclerView.Adapter<ReciveAdapter.MyViewHolder> {
    private Context mContext;
    public List<OrderDeatail> mData;
    GetIceInterface getIceInterface;

    public ReciveAdapter(Context mContext, List<OrderDeatail> mData, GetIceInterface getIceInterface) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.recive_product_card, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final OrderDeatail data = mData.get(position);
        holder.txt_name.setText(data.getProduct_name());
        holder.btn_sell.setText(String.valueOf(data.getOrder_qty2()));
        holder.btn_get.setText(String.valueOf(data.getOrder_qty1()));
        holder.btn_get.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                for (int i = 0; i < mData.size(); i++) {
                    if (mData.get(i).getRunno()==data.getRunno()){
                        mData.get(i).setOrder_qty2(mData.get(i).getOrder_qty1());
                        holder.value = String.valueOf(data.getOrder_qty2());
                    }
        ...
        holder.btn_sell.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder.txt_value.setText(String.valueOf(data.getOrder_qty2()) );
...
//
    ...
    private void set_value(OrderDeatail data  ,String value) {
        for (int i = 0; i < mData.size(); i++) {
            if (mData.get(i).getProduct_runno()==data.getProduct_runno()){
                mData.get(i).setOrder_qty2(Integer.parseInt(value));
            }
