...
public class LineSpinerAdapter extends RecyclerView.Adapter<LineSpinerAdapter.MyViewHolder> {
    private Context mContext;
    List<Line> mData;
    SelectCallback selectCallback;
    public LineSpinerAdapter(Context mContext, List<Line> mData,SelectCallback selectCallback) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.select_line_card, parent, false);
